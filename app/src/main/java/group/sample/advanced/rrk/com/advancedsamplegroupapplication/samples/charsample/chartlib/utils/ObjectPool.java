...
// TODO : 아랫단 부분은 주석을 좀 더 꼼꼼히 읽어서 분석하기
...
public class ObjectPool<T extends ObjectPool.Poolable> {
    ...
    public synchronized T get(){
        ...
        result.currentOwnerId = com.github.mikephil.charting.utils.ObjectPool.Poolable.NO_OWNER;
        this.objectsPointer--;
    ...
    public synchronized void recycle(T object){
        if(object.currentOwnerId != com.github.mikephil.charting.utils.ObjectPool.Poolable.NO_OWNER){
